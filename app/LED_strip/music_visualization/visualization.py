...
class Visualizer:
    ...
    def get_effect(self, effect):
        effect_fn = self.effects.get(effect)
        if effect_fn:
            return effect_fn
        raise "Error, no function: {} found when trying to get effect".format(effect)
...
visualization_effect = Visualizer().get_effect("wavelength")
